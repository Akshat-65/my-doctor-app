...
const PatientSignUp = () => {
  ...
  return (
    ...
    >
      ...
      />
      <Box>
        <FormLabel id="gender" sx={{ color: "black" }}>Gender*</FormLabel>
        ...
        <Box>
          <FormLabel id="gender" sx={{ color: "black" }}>Date of birth*</FormLabel>
        </Box>
        <Box sx={{ mb: "1rem" }}>
          <select
            name=""
      ...
      <InputLabel htmlFor="mobile" sx={{ color: "black" }}>Mobile Number*</InputLabel>
      <OutlinedInput
        id="mobile"
        ...
        sx={{ mb: "1rem", width: "97%" }}
      />
      <InputLabel htmlFor="email" sx={{ color: "black" }}>Email*</InputLabel>
      <OutlinedInput
        id="email"
        ...
        sx={{ mb: "1rem", width: "97%" }}
      />
      <InputLabel htmlFor="password" sx={{ color: "black" }}>Create Password*</InputLabel>
      <OutlinedInput
        id="password"
