...
const Specialities = () => {
  ...
  pages = Math.ceil((specializationData[0]?.totalSpecializations)*(10) / SpecialitiesPerPage);
  ...
  const requiredSpecialitiesPerPage = specializationData.slice(startPageData, endPageData);
